...
func _init_ability_handler(character: CombatCreatureBaseClass) -> void:
	timers_group_node = character.create_timer_group("AbilityTimers")
	projectile_group_node = character.create_timer_group("ProjectilesTimers")
